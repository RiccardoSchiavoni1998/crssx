    ...
    if t>0 and l>t:
        ...
        if mode == "bf":
            ...
            if partial_cost <= current_best:
                ...
                nn_costs, c_0 = find_best_nn(k, l, epsilon, u1, u2, list_a, list_a, current_best)
...
def bjmm_2LV(p, n, k, z, alpha_d, zD, alpha_e, min_epsilon, max_epsilon, min_delta, max_delta, set_, mode, current_best, sec_level = 0, verb = False):
    ...
    if verb: print("Inizio", "Bjmm 2lv on set ", set_, mode, "\nParams:", p, n, k, z)
    list_cost=[]
                ...
                for delta in range(min_delta, max_delta+1):
                    ...
                    if res_details != {} and total_cost<=current_best:
                            ...
                            if total_cost < sec_level:
                                if verb: print("Finito",  "Bjmm 2lv on set", set_, mode, "  Params:", p, n, k, z, "  Not Secure\n")
    ...
    if verb: print("Finito",  "Bjmm 2lv on set", set_, mode, "  Params:", p, n, k, z, "  Secure\n")
   
    return current_best, list_cost, True   

##################################################### INTERFACCE #########################################################################
def bjmm_2LV_opt_size_pk(p, n, k, z, data, current_best, sec_level, verb):
    data = {"BF on Set E":"", "NN on Set E":"", "BF on Shifted_E Set":"", "NN on Shifted_E Set":""}
    safe = False
    alpha_d, zD = create_d_set(p,z)
    alpha_e = 1
    
    min_epsilon_E = data['rangeSetE2']['min_epsilon_E']
    max_epsilon_E = data['rangeSetE2']['max_epsilon_E']
    min_delta_E = data['rangeSetE2']['min_delta_E']
    max_delta_E = data['rangeSetE2']['max_delta_E']
    
    min_epsilon_ES = data['rangeSetShiftedE2']['min_epsilon_ES']
    max_epsilon_ES = data['rangeSetShiftedE2']['max_epsilon_ES']
    min_delta_ES = data['rangeSetShiftedE2']['min_delta_ES']
    max_delta_ES = data['rangeSetShiftedE2']['max_delta_ES']
...
def bjmm_2LV_interface(p, n, k, z, data):
    data = {}
    current_best = n+40
    ...
    # Set E
    min_epsilon_E = data['setE']['min_epsilon_E']
    max_epsilon_E = data['setE']['max_epsilon_E']
    
    min_delta_E = data['setE']['min_delta_E']
    max_delta_E = data['setE']['max_delta_E']
    ...
    # Set shifted E
    min_epsilon_ES = data['setShiftedE']['min_epsilon_ES']
    max_epsilon_ES = data['setShiftedE']['max_epsilon_ES']
    
    min_delta_ES = data['setShiftedE']['min_delta_ES']
    max_delta_ES = data['setShiftedE']['max_delta_ES']
    ...
    # Set EuD
    min_epsilon_EuD = data['setEuD']['min_epsilon_EuD']
    max_epsilon_EuD = data['setEuD']['max_epsilon_EuD']
    min_delta_EuD = data['setEuD']['min_delta_EuD']
    max_delta_EuD = data['setEuD']['max_delta_EuD']
    ...
    # Set shifted EuD
    min_epsilon_EuDS = data['setShiftedEuD']['min_epsilon_EuDS']
    max_epsilon_EuDS = data['setShiftedEuD']['max_epsilon_EuDS']
    min_delta_EuDS = data['setShiftedEuD']['min_delta_EuDS']
    max_delta_EuDS = data['setShiftedEuD']['max_delta_EuDS'] 
