...
#cost_evaluator(p, n, k, z, zD, l, u0, d0, ε1, δ1, ε2, δ2, alpha_e, alpha_d, "E", current_best, find_best_nn) #ERWIN
...
#SEBASTIAN RANGES
def bjmm_3lv_E(p, n, k, z, zD, alpha_e, alpha_d, cost_evaluator, mode, current_best, sec_level = 999):
            ...
            for ε2 in range(0, max_ε2+1):
                ...
                for δ1 in range(0, min(max_δ1, 17)+1):
                    ...
                    for δ2 in range(0, min(max_δ2, 9)+1):
                        ...
                        ##print(("l, ε1, ε2, δ1, δ2 :", l, ε1, ε2, δ1, δ2, "on:", n-k+1, max_δ1, max_δ2, cost, current_best, " ==> ", str(len(res_details) != {} and cost < current_best))
...
def bjmm_3lv_shifted(p, n, k, z, zD, alpha_e, alpha_d, cost_evaluator, mode, current_best, sec_level = 999):
        ...
        for u0 in range(8, k+l+1):
            ...
            for δ1 in range(0, max_δ1+1):
                ...
                for δ2 in range(0, max_δ2+1):
                    ...
                    ##print(("l, u0, δ1, δ2 :", l, u0, δ1, δ2, "on:", n-k+1, max_δ1, max_δ2, cost, current_best, " ==> ", str(len(res_details) != {} and cost < current_best))
...
def bjmm_3LV_opt_size_pk(p, n, k, z, zD, alpha_e, alpha_d, current_best, sec_level):
    data = {"BF on Set E":"", "NN on Set E":"", "BF on Shifted Set":"", "NN on Shifted Set":""}
    safe = False
    current_best_S_BF, data_S_bf, res_S_bf = bjmm_3lv_shifted(p, n, k, z-1, zD, alpha_e, alpha_d, cost_evaluator_bf, "bf", current_best, sec_level)
    data["BF on Shifted Set"] = current_best_S_BF
    print("finito 3 S bf", p, n, k, z, res_S_bf, current_best_S_BF)
    #print("finito 3 E bf")
    if res_S_bf:
        
        current_best_S_NN, data_S_nn, res_S_nn = bjmm_3lv_shifted(p, n, k, z-1, zD, alpha_e, alpha_d, cost_evaluator_nn, "nn", current_best_S_BF, sec_level)
        data["NN on Shifted Set"] = current_best_S_NN
        print("finito 3 S nn" , p, n, k, z, res_S_nn, current_best_S_NN)
        #print("finito 3 E nn")
        if res_S_nn:
            
            current_best_E_NN, data_E_nn, res_E_nn = bjmm_3lv_E(p, n, k, z, zD, alpha_e, alpha_d, cost_evaluator_nn, "nn", current_best_S_NN, sec_level)
            data["NN on Set E"] = current_best_E_NN
            print("finito 3 E NN" , p, n, k, z, res_E_nn, current_best_E_NN)
            #print("finito 3 S bf")
            if res_E_nn:
                
                current_best_E_BF, data_E_bf, res_E_bf = bjmm_3lv_E(p, n, k, z, zD, alpha_e, alpha_d, cost_evaluator_bf, "bf", current_best_E_NN, sec_level)
                data["BF on Set E"] = current_best_E_BF
                print("finito 3 E BF" , p, n, k, z, res_E_bf, current_best_E_BF)
                #print("finito 3 S nn")
                if res_E_bf:
                    safe = True
    print(safe)
...
def bjmm_3LV(p, n, k, z, zD, alpha_e, alpha_d):
    data = {}
    safe = False
    data_E_bf, res_E_bf = bjmm_3lv_E(p, n, k, z, zD, alpha_e, alpha_d, cost_evaluator_bf, "bf")
    data_E_nn, res_E_nn = bjmm_3lv_E(p, n, k, z, zD, alpha_e, alpha_d, cost_evaluator_nn, "nn")
    data_S_bf, res_S_bf = bjmm_3lv_shifted(p, n, k, z-1, zD, alpha_e, alpha_d, cost_evaluator_bf, "bf")
    data_S_nn, res_S_nn = bjmm_3lv_shifted(p, n, k, z-1, zD, alpha_e, alpha_d, cost_evaluator_nn, "nn")
